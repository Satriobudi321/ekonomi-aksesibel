...
Permintaan seorang konsumen terhadap suatu barang dipengaruhi 
...
Hubungan antara pendapatan dan jumlah barang yang diminta bersifat 
...
Pada umumnya, barang konsumsi memiliki penggunaan yang saling 
...
Selera konsumen bersifat subjektif karena selera konsumen 
...
Konsep penawaran menunjukkan berbagai jumlah (kuantitas) barang 
...
Penggunaan teknologi memiliki peranan penting dalam kegiatan 
...
Elastisitas harga permintaan (Ep) mengukur berapa persen permintaan 
...
tersebut, lebih tepat jika diukur dengan elastisitas busur (arch elasticity), 
...
1 merupakan barang mewah (luxurius goods).
Adapun barang dengan nilai Ei < 0 merupakan barang inferior 
...
persen. Elastisitas penawaran juga dapat dihubungkan dengan faktorfaktor atau variabel lain yang dianggap memengaruhinya, seperti tingkat 
...
Pada kondisi ini, akan tercipta harga keseimbangan (equilibrium 
price) dan jumlah keseimbangan (equilibrium quantity). Pada kondisi 
...
dengan cara tabel, cara kurva, dan cara matematis. 
...
(a) Di Indonesia, monopoli yang dilakukan negara terhadap cabangcabang produksi yang penting dan menguasai hajat hidup orang banyak telah memberikan manfaat yang besar terhadap masyarakat. 
...
Permintaan dalam pasar input memiliki sifat saling kebergantungan 
...
Permintaan konsumen terhadap barang-barang adalah untuk 
memenuhi kebutuhannya. Namun, permintaan faktor produksi (input) 
oleh produsen akan digunakan untuk menghasilkan produk yang dibutuhkan 
oleh konsumen. Oleh karena itu, permintaan input bergantung pada 
permintaan barang yang dibutuhkan konsumen.
Berikut faktor-faktor yang memengaruhi permintaan terhadap input
(faktor produksi), yaitu sebagai berikut.

#### a. Harga Faktor Produksi

Dalam kondisi normal, semakin murah harga faktor produksi, 
...
Jika faktor produksi yang satu dengan faktor produksi yang lain 
memiliki hubungan yang bersifat komplementer, meningkatnya 
permintaan terhadap faktor produksi yang satu akan semakin meningkatkan permintaan faktor produksi lainnya. Adapun, jika hubungannya 
...
Pengaruh harga faktor produksi terhadap permintaan faktor produksi 
...
Oleh karena sifat permintaan input merupakan turunan (derived), 
